...
import { Search, Filter, Lock, ArrowRight, ChevronDown, ChevronLeft, ChevronRight, Check, CheckCircle2, X, RefreshCw } from 'lucide-react';
...
const Endpoints = ({ activeScanId, assignedDomains, selectedDomain, setSelectedDomain, scansList, handleSelectScan }) => {
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [searchTerm, methodFilter, riskFilter, activeScanId]);
